      ...
      CASE 30:
        ...
        IF nParams=7 OR nParams=8 THEN
          ...
          IF BUFFER_POS<MAX_BUFFER THEN
            ...
            bufferSpeeds{BUFFER_POS}:=currentSpeedL;
            IF nParams=8 THEN
          ...
          FOR i FROM 1 TO (BUFFER_POS) DO
            IF collision=0 THEN
              ...
              IF params{1}=1 THEN
                ...
                MoveL bufferTargets{i} \ID:=i, bufferSpeeds{i},currentZoneL,currentToolL\WObj:=currentWobjL;
                IF params{2}=1 THEN
      ...
      CASE 37:
        ...
        IF nParams=7 THEN
          ...
          IF BUFFER_JOINT_POS<MAX_BUFFER THEN
              ...
              bufferJointSpeeds{BUFFER_JOINT_POS}:=currentSpeedL;
          ENDIF
          ok:=SERVER_OK;
        ELSE
          ok:=SERVER_BAD_MSG;
